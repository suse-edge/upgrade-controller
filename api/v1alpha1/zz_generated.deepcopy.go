...
func (in *CoreComponent) DeepCopyInto(out *CoreComponent) {
	*out = *in
	if in.Containers != nil {
		...
		*out = make([]CoreComponentContainer, len(*in))
		copy(*out, *in)
	}
}
...
func (in *CoreComponentContainer) DeepCopy() *CoreComponentContainer {
	...
	out := new(CoreComponentContainer)
	in.DeepCopyInto(out)
	return out
}
...
func (in *KubernetesDistribution) DeepCopyInto(out *KubernetesDistribution) {
	*out = *in
	if in.CoreComponents != nil {
		in, out := &in.CoreComponents, &out.CoreComponents
		*out = make([]CoreComponent, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
